...
struct i2c_pads_info i2c_pad_info1 = {
	...
	.scl = {
		.i2c_mode = IOMUX_PADS(PAD_KEY_COL3__I2C2_SCL | PC,
		.gpio_mode = IOMUX_PADS(PAD_KEY_COL3__GPIO4_IO12 | PC,
		.gp = IMX_GPIO_NR(4, 12)
	},
	.sda = {
		.i2c_mode = IOMUX_PADS(PAD_KEY_ROW3__I2C2_SDA | PC,
		.gpio_mode = IOMUX_PADS(PAD_KEY_ROW3__GPIO4_IO13 | PC,
		.gp = IMX_GPIO_NR(4, 13)
	}
};
...
struct i2c_pads_info i2c_pad_info2 = {
	.scl = {
		.i2c_mode = IOMUX_PADS(PAD_GPIO_5__I2C3_SCL | PC,
		.gpio_mode = IOMUX_PADS(PAD_GPIO_5__GPIO1_IO05 | PC,
		.gp = IMX_GPIO_NR(1, 5)
	},
	.sda = {
		.i2c_mode = IOMUX_PADS(PAD_EIM_D18__I2C3_SDA | PC,
		.gpio_mode = IOMUX_PADS(PAD_EIM_D18__GPIO3_IO18 | PC,
		.gp = IMX_GPIO_NR(3, 18)
	}
};
...
iomux_v3_cfg_t const usdhc1_pads[] = {
	...
	IOMUX_PADS(PAD_SD1_CLK__SD1_CLK	| MUX_PAD_CTRL(USDHC1_PAD_CTRL_CLK)),
	IOMUX_PADS(PAD_SD1_CMD__SD1_CMD	| MUX_PAD_CTRL(USDHC1_PAD_CTRL_NEW)),
	IOMUX_PADS(PAD_SD1_DAT0__SD1_DATA0	| MUX_PAD_CTRL(USDHC1_PAD_CTRL_NEW)),
	IOMUX_PADS(PAD_SD1_DAT1__SD1_DATA1	| MUX_PAD_CTRL(USDHC1_PAD_CTRL_NEW)),
	IOMUX_PADS(PAD_SD1_DAT2__SD1_DATA2	| MUX_PAD_CTRL(USDHC1_PAD_CTRL_NEW)),
	IOMUX_PADS(PAD_SD1_DAT3__SD1_DATA3	| MUX_PAD_CTRL(USDHC1_PAD_CTRL_NEW)),
...
// TBD	IOMUX_PADS(PAD_SD4_DAT0__RAWNAND_DQS		| MUX_PAD_CTRL(GPMI_PAD_CTRL1)),
};
...
iomux_v3_cfg_t const backlight_pads[] = {
	IOMUX_PADS(PAD_DI0_PIN4__GPIO4_IO20 | MUX_PAD_CTRL(ENET_PAD_CTRL)),
