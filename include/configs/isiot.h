...
#define SHOW_ENGICAM_NOTE        "Note:    Geamx6ul IsIoT default U-Boot\n"
	...
	#define CONFIG_DEFAULT_FDT_FILE		"isiot-imx6ul-emmc.dtb"
#else
	#define CONFIG_STR_MMC_DEV "0"
	#define CONFIG_MMCROOT			"/dev/mmcblk0p2"  /* USDHC2 */
	#define CONFIG_DEFAULT_FDT_FILE		"isiot-imx6ul.dtb"
#endif
